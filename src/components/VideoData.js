                                    ...
                                    {i === 3 && 
                                        <div className="profile-title-container">
                                            ...
                                            <div className="data-wrap">
                                                ...
                                                <h4>Youtube Publish Date: <span>{this.state.data[key].publishedAt}</span></h4>
                                            </div>
                                    ...
                                    {i === 5 &&
                                        <div className="statistics">
                                            ...
                                            <div className="data-wrap">
                                                ...
                                                <h4>Comments: <span>{this.state.data[key].commentCount}</span></h4>
                                                <h4>Subscribers: <span>{this.state.data[key].subscriberCount}</span></h4>
                                        ...
                                        <div className="status">
                                            ...
                                            <div className="data-wrap">
                                                ...
                                                <h4>Long uploads: <span>{this.state.data[key].longUploadsStatus}</span></h4>
                                                <h4>Made for kids: {this.state.data[key].madeForKids ? <span>True</span> : <span>False</span>  }</h4>
                                            </div>
                                        </div>}
                                </React.Fragment>
                            )
